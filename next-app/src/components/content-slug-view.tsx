                      ...
                      {({ phone, phoneHref, afterHoursPhone, afterHoursPhoneHref }) => (
                        <div className="flex flex-col sm:flex-row flex-wrap gap-3">
                          ...
                          <a
                            ...
                            className="inline-flex items-center gap-2 bg-white/15 hover:bg-white/25 text-white font-bold px-6 py-3 rounded-2xl border border-white/30 transition-colors"
                          >
